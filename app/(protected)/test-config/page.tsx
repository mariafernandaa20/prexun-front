    ...
    <div className="container mx-auto p-6">
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            <strong>Período por defecto:</strong> {config?.default_period_id || 'No configurado'}
          </div>
          <div>
          ...
          <div>
            <strong>Métodos de pago habilitados:</strong> {config?.payment_methods_enabled?.join(', ')}
          </div>
          <div>
            <strong>Método de pago por defecto:</strong> {config?.default_payment_method}
          </div>
