        ...
        <div className="flex flex-col">
          ...
          <div className="mb-4">
            <label className="text-sm font-medium mb-2 block">
              Instrucciones Activas (se usan automáticamente):
            </label>
            <div className="p-3 border rounded-md bg-gray-50 min-h-[60px]">
              {contexts.filter((c) => c.is_active).length > 0 ? (
                ...
                <p className="text-sm text-gray-500">
                  No hay instrucciones activas. Activa algunas instrucciones
                  para que se usen automáticamente.
                </p>
              )}
            </div>
          </div>
              ...
              <div className="max-h-[calc(100vh-25rem)] overflow-y-auto">
                ...
                {contexts.length === 0 && (
                  <div className="text-center py-8 text-muted-foreground">
                    No hay instrucciones creadas. Crea la primera instrucción
                    para comenzar.
                  </div>
                )}
              </div>
