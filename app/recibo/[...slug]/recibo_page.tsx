          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6 lg:mb-8">
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className='bg-yellow-200 p-2'>{invoice.paid ? invoice.folio_new + (invoice.folio || invoice.folio_cash || invoice.folio_transfer).toString().padStart(3, '0') : 'No Pagado'}</span>
              </div>
              <div className="flex justify-between">
