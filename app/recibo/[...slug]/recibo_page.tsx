      ...
      return {
        ...
        dates: (() => {
          ...
          if (assignment.grupo?.start_date && assignment.grupo?.end_date) {
            ...
            assignment.semanaIntensiva?.start_date &&
            assignment.semanaIntensiva?.end_date
          ) {
            return {
        ...
        frequency:
          assignment.grupo?.frequency ||
          assignment.semanaIntensiva?.frequency ||
          null,
        schedule: (() => {
          if (assignment.grupo) {
            return {
        ...
        <div className="w-full mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between mb-6 lg:mb-8 gap-2">
            <div className="flex items-center">
              <Image
                ...
                width={120}
                height={40}
                className="w-32 md:w-40 lg:w-150 h-auto"
              />
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6 lg:mb-8">
            <div>
              ...
              <p className="text-gray-600">
                {invoice.campus?.name || 'Campus no especificado'}
              </p>
              <p className="text-gray-600">
                {invoice.campus?.address || 'Dirección no disponible'}
              </p>
                        ...
                        <div>
                          ...
                          {assignmentDisplay.grupo && (
                            <div className="font-medium text-gray-700 text-xs lg:text-sm mt-1">
                              Grupo: {assignmentDisplay.grupo.name} |{' '}
                              {assignmentDisplay.grupo.type ||
                          ...
                          {assignmentDisplay.semanaIntensiva && (
                            <div className="font-medium text-gray-700 text-xs lg:text-sm mt-1">
                              Semana Intensiva:{' '}
                              {assignmentDisplay.semanaIntensiva.name} |{' '}
                              {assignmentDisplay.semanaIntensiva.type ||
                                'Tipo no especificado'}
                            </div>
                          )}
                          ...
                          <div className="text-gray-500 text-xs lg:text-sm mt-1">
                            ...
                            {assignmentDisplay.schedule && (
                              <p>
                                {assignmentDisplay.schedule.start || 'N/A'} -{' '}
                                {assignmentDisplay.schedule.end || 'N/A'}
                              </p>
                            )}
                            <p>{invoice.notes || ''}</p>
                          </div>
          ...
          <div className="flex justify-end mb-6 lg:mb-8">
            <div className="text-right w-full sm:w-1/2 md:w-1/3">
              <div className="flex justify-between font-bold gap-2">
                ...
                <span>
                  MX$
                  {invoice.amount ? (invoice.amount / 1.16).toFixed(2) : '0.00'}
                </span>
              </div>
              <div className="flex justify-between font-bold gap-2">
                <span>IVA</span>
                <span>
                  MX$
                  {invoice.amount
                    ? (invoice.amount - invoice.amount / 1.16).toFixed(2)
                    : '0.00'}
                </span>
              </div>
          ...
          <div className="border-t pt-6 lg:pt-8 text-xs">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
              <p className="text-gray-600">
                1. Este es un "Comprobante de pago", por ende, no es un
                comprobante fiscal o una factura.
              </p>
              <p className="text-gray-600">
                2. Todas las tarifas se muestran en MXN y están sujetas a
                impuestos sobre las ventas (según corresponda).
              </p>
              <p className="text-gray-600">
                3. No se hacen devoluciones o compensaciones de ninguna índole.
              </p>
              <p className="text-gray-600">
                4. El valor de promoción solo aplica si se liquida en las fechas
                convenidas.
              </p>
              <p className="text-gray-600">
                5. El libro de estudios se entregará una semana previa al inicio
                de clases.
              </p>
              <p className="text-gray-600">
                6. Si usted requiere factura, solicitar al registrarse; no se
                emitirá en caso de no ser solicitada en la inscripción.
              </p>
              <p className="text-gray-600">
                7. Nuestro material está protegido por derechos de autor, hacer
                uso con fines diferentes al establecido es perseguido por la
                ley.
              </p>
              <p className="text-gray-600">
                8. En las sesiones de clase y evaluaciones no se permite usar o
                tener en las manos teléfonos celulares.
              </p>
              <p className="text-gray-600">
                9. Los padres o tutores encargados del alumno deberán solicitar
                informes de su desempeño durante el curso.
              </p>
              <p className="text-gray-600">
                10. Si por alguna situación esporádica el Estado suspende las
                clases presenciales, las clases serán en línea.
              </p>
            </div>
            <div className="mt-4 flex flex-col sm:flex-row items-start sm:items-center gap-2">
              <a
                href="https://asesoriasprexun.com/terminos-y-condiciones/"
                target="_blank"
                rel="noreferrer"
              ...
              <Image
                src="/qr.png"
                alt="Prexun Términos y Condiciones"
                width={100}
                height={100}
                className="w-24 h-24"
              />
